...
from my_adds.im200 import ImageFolder200
...
def main(args):
    ...
    dataset = ImageFolder200(args.data_path, transform=transform)
    ...
    for x, y in loader:
        ...
        with torch.no_grad():
            ...
            x = vae.encode(x).latent_dist.sample().mul_(0.18215) # type: ignore
